...
class OnboardingThirdViewController: UIViewController, Storyboarded {
...
//    @IBOutlet weak var imageBottomConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        //here
        titleLabel.text = "Use biometric authorization"
        subtitleLabel.text = "Unlock with Face or Touch ID for quick access"
...
//        }
    ...
    @objc func showFourthOnboardingScreen() {
        VibratorEngine.shared.actionTaptic()
        self.coordinator?.showOnboardingFourthScreen()
    }
